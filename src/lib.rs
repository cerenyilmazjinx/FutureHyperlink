// src/lib.rs
/*
 * Core library for FutureHyperlink
 */
...
#[derive(Debug)]
pub struct FutureHyperlinkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FutureHyperlinkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FutureHyperlink processing");
    
    let mut processor = FutureHyperlinkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FutureHyperlinkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FutureHyperlinkProcessor::new(false);
